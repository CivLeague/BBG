...
INSERT INTO TraitModifiers (TraitType , ModifierId)
	SELECT 'TRAIT_LEADER_MELEE_COASTAL_RAIDS'          , 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST'
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST');

INSERT INTO TraitModifiers (TraitType , ModifierId)
	SELECT 'TRAIT_LEADER_MELEE_COASTAL_RAIDS'          , 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST'
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST');

INSERT INTO TraitModifiers (TraitType , ModifierId)
	SELECT 'TRAIT_CIVILIZATION_EARLY_OCEAN_NAVIGATION' , 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST'
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST');
	
INSERT INTO Modifiers (ModifierId , ModifierType , SubjectRequirementSetId)
	SELECT 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST'               , 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION'                 , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST');

INSERT INTO Modifiers (ModifierId , ModifierType , SubjectRequirementSetId)
	SELECT 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST'               , 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION'                 , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST');

INSERT INTO Modifiers (ModifierId , ModifierType , SubjectRequirementSetId)
	SELECT 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST' , 'MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL' , 'PLOT_IS_COASTAL_LAND_REQUIREMENTS'
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST');
	
INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST'               , 'DistrictType' , 'DISTRICT_HOLY_SITE' , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST');

INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST'               , 'Amount'       , '50'                 , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_DISTRICT_BOOST');

INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST'               , 'DistrictType' , 'DISTRICT_HOLY_SITE' , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST');

INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST'               , 'Amount'       , '50'                 , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'THUNDERBOLT_HOLY_SITE_BUILDING_BOOST');

INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST' , 'YieldType'    , 'YIELD_GOLD'         , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST');

INSERT INTO ModifierArguments (ModifierId , Name , Value , Extra , SecondExtra)
	SELECT 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST' , 'Amount'       , '2'                  , null , null
	WHERE (SELECT 1 FROM Modifiers WHERE ModifierId = 'NORWEGIAN_COASTAL_CITIES_INTERNATIONAL_TRADE_BOOST');
