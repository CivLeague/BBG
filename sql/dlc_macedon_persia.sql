...
-- Macedon
--==========
-- half cost Basilikoi Paides
UPDATE Buildings SET Cost=45 WHERE BuildingType='BUILDING_BASILIKOI_PAIDES';
-- adj general bugfix
...
-- hypaspist get bonus against cities so they arent overshadowed by hetairoi
...
INSERT INTO TraitModifiers (TraitType , ModifierId)
	VALUES
	('TRAIT_CIVILIZATION_HELLENISTIC_FUSION' , 'TRAIT_CIVILIZATION_HELLENISTIC_FUSION_PRODUCTION');
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
	('TRAIT_CIVILIZATION_HELLENISTIC_FUSION_PRODUCTION'			, 'MODIFIER_PLAYER_CAPTURED_CITY_ATTACH_MODIFIER'),
	('TRAIT_CIVILIZATION_HELLENISTIC_FUSION_PRODUCTION_MODIFIER', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER');
INSERT INTO ModifierArguments (ModifierId , Name , Value) VALUES
