...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('SHRINE_GREAT_GENERAL_POINT_BBG', 'MODIFIER_PLAYER_CITIES_ADJUST_GREAT_PERSON_POINT', 'BUILDING_IS_SHRINE');
...
INSERT INTO Types (Type, Kind) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'KIND_ABILITY');
INSERT INTO Types (Type, Kind) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'KIND_ABILITY');
INSERT INTO Types (Type, Kind) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'KIND_ABILITY');
INSERT INTO Types (Type, Kind) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_RECON');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_RECON');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_RECON');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_RECON');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_MELEE');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_MELEE');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_MELEE');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_MELEE');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_ANTI_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_ANTI_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_ANTI_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_ANTI_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_RANGED');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_RANGED');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_RANGED');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_RANGED');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_LIGHT_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_LIGHT_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_LIGHT_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_LIGHT_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_HEAVY_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_HEAVY_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_HEAVY_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_HEAVY_CAVALRY');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_RELIGIOUS_ALL');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_RELIGIOUS_ALL');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_RELIGIOUS_ALL');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_RELIGIOUS_ALL');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'CLASS_WARRIOR_MONK');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'	, 'CLASS_WARRIOR_MONK');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'CLASS_WARRIOR_MONK');
INSERT INTO TypeTags (Type, Tag) VALUES ('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'	, 'CLASS_WARRIOR_MONK');
INSERT INTO UnitAbilities (UnitAbilityType, Name, Description, Inactive) VALUES
	('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG', 'LOC_ABILITY_COMBAT_BONUS_FOR_FOLLOWER_NAME_BBG', 'LOC_ABILITY_COMBAT_BONUS_FOR_FOLLOWER_DESC_BBG', 1),
	('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG' , 'LOC_ABILITY_COMBAT_BONUS_FOR_FOUNDER_NAME_BBG' , 'LOC_ABILITY_COMBAT_BONUS_FOR_FOUNDER_DESC_BBG' , 1),
	('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG', 'LOC_ABILITY_COMBAT_BONUS_FOR_ENHANCER_NAME_BBG', 'LOC_ABILITY_COMBAT_BONUS_FOR_ENHANCER_DESC_BBG', 1),
	('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG' , 'LOC_ABILITY_COMBAT_BONUS_FOR_WORSHIP_NAME_BBG' , 'LOC_ABILITY_COMBAT_BONUS_FOR_WORSHIP_DESC_BBG' , 1);
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG', 'COMBAT_BONUS_MODIFIER_FOR_FOLLOWER_BELIEF_BBG'),
	('ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG' , 'COMBAT_BONUS_MODIFIER_FOR_FOUNDER_BELIEF_BBG'),
	('ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG', 'COMBAT_BONUS_MODIFIER_FOR_ENHANCER_BELIEF_BBG'),
	('ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG' , 'COMBAT_BONUS_MODIFIER_FOR_WORSHIP_BELIEF_BBG');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('ATTACH_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'		, 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 'HAS_A_RELIGION_BBG'),
	('ATTACH_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG' 		, 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 'RELIGION_HAS_FOUNDER_BELIEF_REQUIREMENTS_CPLMOD'),
	('ATTACH_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'		, 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 'RELIGION_HAS_ENHANCER_BELIEF_REQUIREMENTS_CPLMOD'),
	('ATTACH_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG' 		, 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 'RELIGION_HAS_WORSHIP_BELIEF_REQUIREMENTS_CPLMOD'),
	('COMBAT_BONUS_MODIFIER_FOR_FOLLOWER_BELIEF_BBG'	, 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', NULL),
	('COMBAT_BONUS_MODIFIER_FOR_FOUNDER_BELIEF_BBG'		, 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', NULL),
	('COMBAT_BONUS_MODIFIER_FOR_ENHANCER_BELIEF_BBG'	, 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', NULL),
	('COMBAT_BONUS_MODIFIER_FOR_WORSHIP_BELIEF_BBG'		, 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('ATTACH_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'	, 'AbilityType', 'ABILITY_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'),
	('ATTACH_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG' 	, 'AbilityType', 'ABILITY_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'),
	('ATTACH_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'	, 'AbilityType', 'ABILITY_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'),
	('ATTACH_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG' 	, 'AbilityType', 'ABILITY_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG'),
	('COMBAT_BONUS_MODIFIER_FOR_FOLLOWER_BELIEF_BBG', 'Amount', '1'),
...
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
	('COMBAT_BONUS_MODIFIER_FOR_FOLLOWER_BELIEF_BBG', 'Preview', 'LOC_COMBAT_BONUS_MODIFIER_FOR_FOLLOWER_BELIEF_BBG'),
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
	('TRAIT_LEADER_AGGRESSIVE_MILITARY', 'ATTACH_COMBAT_BONUS_FOR_FOLLOWER_BELIEF_BBG'),
	('TRAIT_LEADER_AGGRESSIVE_MILITARY', 'ATTACH_COMBAT_BONUS_FOR_FOUNDER_BELIEF_BBG'),
	('TRAIT_LEADER_AGGRESSIVE_MILITARY', 'ATTACH_COMBAT_BONUS_FOR_ENHANCER_BELIEF_BBG'),
	('TRAIT_LEADER_AGGRESSIVE_MILITARY', 'ATTACH_COMBAT_BONUS_FOR_WORSHIP_BELIEF_BBG');
-- replace Territorial Expansion Declaration Bonus with +1 movement
DELETE FROM TraitModifiers WHERE TraitType='TRAIT_LEADER_ARTHASHASTRA' AND ModifierId='TRAIT_TERRITORIAL_WAR_COMBAT';
DELETE FROM TraitModifiers WHERE TraitType='TRAIT_LEADER_ARTHASHASTRA' AND ModifierId='TRAIT_TERRITORIAL_WAR_MOVEMENT';
DELETE FROM TraitModifiers WHERE TraitType='TRAIT_LEADER_ARTHASHASTRA' AND ModifierId='TRAIT_TERRITORIAL_WAR_PREREQ_OVERRIDE';
...
INSERT INTO Adjacency_YieldChanges (ID , Description , YieldType , YieldChange , TilesRequired, Self)
    VALUES
    ('District_Harbor_Gold_Positive_BBG' , 'LOC_HARBOR_BASE_DISTRICT_POSITIVE_ADJACENCY_DESCRIPTION' , 'YIELD_GOLD' ,  2 , 1, 1),
    ('District_Harbor_Gold_Negative_BBG' , 'LOC_HARBOR_BASE_DISTRICT_NEGATIVE_ADJACENCY_DESCRIPTION' , 'YIELD_GOLD' , -2 , 1, 1);
INSERT INTO District_Adjacencies (DistrictType , YieldChangeId)
    VALUES
