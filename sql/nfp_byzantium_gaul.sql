...
INSERT INTO RequirementSets(RequirementSetId, RequirementSetType)
    VALUES ('HAS_BRONZE_WORKING_REQUIREMENTS_BBG', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId)
    VALUES ('HAS_BRONZE_WORKING_REQUIREMENTS_BBG', 'HAS_BRONZE_WORKING_REQUIREMENT_BBG');
INSERT INTO Requirements(RequirementId , RequirementType)
    VALUES ('HAS_BRONZE_WORKING_REQUIREMENT_BBG', 'REQUIREMENT_PLAYER_HAS_TECHNOLOGY');
INSERT INTO RequirementArguments(RequirementId, Name, Value)
    VALUES ('HAS_BRONZE_WORKING_REQUIREMENT_BBG', 'TechnologyType', 'TECH_BRONZE_WORKING');
UPDATE Modifiers SET OwnerRequirementSetId='HAS_BRONZE_WORKING_REQUIREMENTS_BBG' WHERE ModifierId='GAUL_MINE_CULTURE';