...
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType) VALUES
	('MANAGER_UNIT_GOLD_DISCOUNT_BBG', 'MODIFIER_SINGLE_CITY_ADJUST_ALL_UNITS_PURCHASE_COST'),
...
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('MANAGER_UNIT_GOLD_DISCOUNT_BBG', 'Amount', '50'),
...
INSERT OR IGNORE INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
	VALUES
		('GOVERNOR_PROMOTION_MANAGER_BBG', 'MANAGER_UNIT_GOLD_DISCOUNT_BBG'),
...
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('FORESTRY_MANAGEMENT_BREATHTAKING_GOLD_BBG', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 'PLOT_BREATHTAKING_APPEAL');
INSERT OR IGNORE INTO ModifierArguments (ModifierId, Name, Value) VALUES
	('FORESTRY_MANAGEMENT_BREATHTAKING_GOLD_BBG', 'Amount', '2'),
	('FORESTRY_MANAGEMENT_BREATHTAKING_GOLD_BBG', 'YieldType', 'YIELD_GOLD');
INSERT OR IGNORE INTO GovernorPromotionModifiers VALUES
	('GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT', 'FORESTRY_MANAGEMENT_BREATHTAKING_GOLD_BBG');
-- +1 trade route
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType) VALUES
...
-- swap tax collector and forestry management
DELETE FROM GovernorPromotionPrereqs WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR';
DELETE FROM GovernorPromotionPrereqs WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT';
INSERT INTO GovernorPromotionPrereqs VALUES
	('GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT', 'GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR'),
	('GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT', 'GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER'),
	('GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR', 'GOVERNOR_PROMOTION_MERCHANT_LAND_ACQUISITION');
UPDATE GovernorPromotions SET Level=2, Column=1 WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT';
UPDATE GovernorPromotions SET Level=1, Column=2 WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR';
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MANAGER_BBG' AND PrereqGovernorPromotion='GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR';
UPDATE GovernorPromotionPrereqs SET PrereqGovernorPromotion='GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT' WHERE GovernorPromotionType='GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR' AND PrereqGovernorPromotion='GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR';
