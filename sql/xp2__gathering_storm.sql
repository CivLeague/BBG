...
-- Sweden
--==================
-- +1 to all yields in cap after political philosphy
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
	('SWEDEN_CAPITAL_CULTURE_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY'),
	('SWEDEN_CAPITAL_SCIENCE_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY'),
	('SWEDEN_CAPITAL_FAITH_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY'),
	('SWEDEN_CAPITAL_GOLD_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY'),
	('SWEDEN_CAPITAL_FOOD_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY'),
	('SWEDEN_CAPITAL_PRODUCTION_BBG', 'MODIFIER_PLAYER_CAPITAL_CITY_ADJUST_CITY_YIELD_CHANGE', 'PLAYER_HAS_POLITICAL_PHILOSOPHY');
...
-- pilgrimmage reverted
UPDATE BeliefModifiers SET ModifierID='PILGRIMAGE_FAITH_FOREIGN_CITY' WHERE BeliefType='BELIEF_PILGRIMAGE';
...
UPDATE Beliefs SET Description='LOC_BELIEF_PILGRIMAGE_DESCRIPTION' WHERE BeliefType='BELIEF_PILGRIMAGE';
