...
--==============================================================
-- Pathfinder [New Card] => +50% production and Double Experience to recon units at Civil Service
INSERT INTO Types (Type, Kind) Values ('POLICY_PATHFINDER', 'KIND_POLICY');
...
INSERT INTO PolicyModifiers (PolicyType, ModifierId) Values ('POLICY_PATHFINDER', 'PATHFINDER_RECON_UNIT_PRODUCTION_AND_EXPERIENCE');
...
INSERT INTO ModifierArguments (ModifierId, Name, Value, Extra)
    Values ('PATHFINDER_RECON_UNIT_PRODUCTION_AND_EXPERIENCE', 'UnitPromotionClass', 'PROMOTION_CLASS_RECON', -1),
        ('PATHFINDER_RECON_UNIT_PRODUCTION_AND_EXPERIENCE', 'EraType', 'ERA_MEDIEVAL', -1 ),
        ('PATHFINDER_RECON_UNIT_PRODUCTION_AND_EXPERIENCE', 'Amount', 50, -1);
UPDATE ObsoletePolicies SET ObsoletePolicy='POLICY_PATHFINDER' WHERE PolicyType='Policy_Survey';
