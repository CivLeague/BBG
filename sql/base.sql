...
INSERT INTO ModifierArguments (ModifierId, Name, Value)
    Values ('PATHFINDER_RECON_UNIT_PRODUCTION', 'UnitPromotionClass', 'PROMOTION_CLASS_RECON'),
        ('PATHFINDER_RECON_UNIT_PRODUCTION', 'EraType', 'NO_ERA'),
        ('PATHFINDER_RECON_UNIT_PRODUCTION', 'Amount', '50');
