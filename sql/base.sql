...
INSERT OR IGNORE INTO Types (Type, Kind) VALUES
	('TRAIT_CIVILIZATION_IMPROVEMENT_BRAZIL_LUMBERMILL', 'KIND_TRAIT');
INSERT OR IGNORE INTO Traits (TraitType, Name, Description) VALUES
	('TRAIT_CIVILIZATION_IMPROVEMENT_BRAZIL_LUMBERMILL', 'LOC_IMPROVEMENT_BRAZIL_LUMBER_MILL_NAME', 'LOC_IMPROVEMENT_LUMBER_MILL_DESCRIPTION');
INSERT OR IGNORE INTO CivilizationTraits (CivilizationType, TraitType) VALUES
	("CIVILIZATION_BRAZIL", 'TRAIT_CIVILIZATION_IMPROVEMENT_BRAZIL_LUMBERMILL');
DROP TABLE IF EXISTS braziltmp;
CREATE TABLE braziltmp AS SELECT * FROM Improvements WHERE ImprovementType='IMPROVEMENT_LUMBER_MILL';
INSERT INTO braziltmp (TraitType) Values ('TRAIT_CIVILIZATION_IMPROVEMENT_BRAZIL_LUMBERMILL');
UPDATE braziltmp SET ImprovementType='IMPROVEMENT_BRAZIL_LUMBER_MILL';
INSERT INTO Improvements SELECT * from braziltmp;
DROP TABLE braziltmp;
...
INSERT OR IGNORE INTO MomentIllustrations (MomentIllustrationType, MomentDataType, GameDataType, Texture) VALUES
	('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT', 'MOMENT_DATA_IMPROVEMENT', 'IMPROVEMENT_BRAZIL_LUMBER_MILL', 'Moment_Infrastructure_Nubia.dds');
